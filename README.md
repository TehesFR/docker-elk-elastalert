...
4. [Storage](#storage)
   ...
   * [Elastalert volumes](#elastalert-volumes)
...
In order to work, elastalert needs two volumes:

1. "/data/elastalert/rules" folder which will contain elastalert rules (see: http://elastalert.readthedocs.io/en/latest/running_elastalert.html#creating-a-rule)
2. "/data/elastalert/config/elastalert.yaml" file (see: config.yaml.example)
